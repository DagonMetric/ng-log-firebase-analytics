...
2. Fork the [repo](https://github.com/dagonmetric/ng-log-firebase-analytics) and create your branch `topic` from master.
...
8. In GitHub, submit a pull request to [dagonmetric/ng-log-firebase-analytics](https://github.com/dagonmetric/ng-log-firebase-analytics).
